...
macro(NEW_CUDA_WRAP_SRCS cuda_target format generated_files)
    ...
    if(CUDA_PROPAGATE_HOST_FLAGS)
      set(CMAKE_HOST_FLAGS "${CMAKE_CXX_FLAGS} ${CUDA_HOST_SHARED_FLAGS}")
    else()
    ...
    set(COMMON_FLAGS "${CMAKE_HOST_FLAGS} ${CMAKE_HOST_FLAGS_${build_type_upper}}")
  ...
  foreach(file ${_argn_list})
        ...
        #message(STATUS "___________ ${CMAKE_CFG_INTDIR} == ${CUDA_NVCC_DEPEND}")
